...
export declare class Outbox__factory extends ContractFactory {
    ...
    deploy(_rollup: string, _bridge: string, overrides?: Overrides): Promise<Outbox>;
    getDeployTransaction(_rollup: string, _bridge: string, overrides?: Overrides): TransactionRequest;
