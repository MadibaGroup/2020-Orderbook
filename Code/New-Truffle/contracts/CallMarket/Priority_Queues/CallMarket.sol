...
//***********************************************************************//
    ...
    */
    ...
    function depositToken(address token, uint256 numofTokens) external returns (bool) {
        ...
        require(IERC20(token).transferFrom(msg.sender, address(this), numofTokens));
...
//***********************************************************************//
    ...
    */ 
    ...
    function depositEther(uint256 numofEthers) external payable returns (bool) {
        totalEtherBalance[msg.sender] += numofEthers;
...
//***********************************************************************//
    ...
    */    
    ...
    {
        require ((totalTokenBalance[msg.sender] - unavailableTokenBalance[msg.sender]) > numofTokens);
...
//***********************************************************************//
    ...
    */     
    ...
    {
        require ((totalEtherBalance[msg.sender] - unavailableEtherBalance[msg.sender]) > numofEthers);
