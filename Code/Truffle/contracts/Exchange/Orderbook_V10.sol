...
contract Orderbook_V10{
uint256 x = 2;

function toy() public  returns (uint256){
    return x;
...
//******************** submitBid function ********************//
    ...
    function submitBid (uint256 _price, uint256 _volume ) public {
        ...
        minheap_insert( msg.sender, _price, _volume );
...
//****************   swap function  *********************//
    ...
    /*function toy () public view returns (uint256)
    {   
        uint256 x = 2;
        return x; 
    }*/
...
//****************   BuyListpeak function  *********************//
    ...
    //function BuyListpeak() public view returns (address _sender, uint256 _price, uint256 _volume){
    function BuyListpeak() public view returns (uint256 _price){
...
//****************   SellListpeak function  *********************//
    ...
    function SellListpeak() public returns (address _sender, uint256 _price, uint256 _volume){
...
//*******************  maxheap_insert () ***************************//
    ...
    function maxheap_insert (address _sender, uint256 _price, uint256 _volume) public
    {
        OrderStruct memory neworder = OrderStruct(_sender, _price ,_volume);
        SellList.push(neworder);
        maxheap_heapifyUp (); //"!SYNTAX!"
    }
...
//*******************  minheap_insert () ***************************//
    ...
    //then heapified up with a call to heapifyUp method
    function minheap_insert (address _sender, uint256 _price, uint256 _volume) internal
    {
