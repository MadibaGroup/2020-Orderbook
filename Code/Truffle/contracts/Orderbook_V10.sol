...
//****************   BuyListpeak function  *********************//
    ...
    function BuyListpeak() public returns (address _sender, uint _price, uint _volume){
...
//****************   SellListpeak function  *********************//
    ...
    function SellListpeak() public returns (address _sender, uint _price, uint _volume){
