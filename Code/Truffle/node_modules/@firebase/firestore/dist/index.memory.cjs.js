...
var h = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return n ? (ye("string" == typeof n.accessToken), new f(n.accessToken, t.currentUser)) : null;
    ...
    return t.now = function() {
        ...
        return this.seconds === t.seconds ? me(this.nanoseconds, t.nanoseconds) : me(this.seconds, t.seconds);
    }, t.prototype.isEqual = function(t) {
...
/** Extracts the backend's type order for the provided value. */ function S(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? V(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : de();
}
...
function O(t, e) {
    var n = S(t), r = S(e);
    if (n !== r) return me(n, r);
    switch (n) {
      case 0 /* NullValue */ :
        return 0;

      case 1 /* BooleanValue */ :
        return me(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return me(t.stringValue, e.stringValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return me(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = me(x(t.latitude), x(e.latitude));
            return 0 !== n ? n : me(x(t.longitude), x(e.longitude));
...
function M(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return me(t, e);
    var n = C(t), r = C(e), i = me(n.seconds, r.seconds);
    return 0 !== i ? i : me(n.nanos, r.nanos);
}
...
var ft, lt, pt = function(t, e) {
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && S(this.value) === S(e) && this.fe(O(e, this.value));
...
var Ut = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.N, this.root.Re(e, n, this.N).Ae(null, null, Lt.Pe, null, null));
    }, 
    ...
    t.prototype.be = function() {
        return new St(this.root, null, this.N, !1);
    }, t.prototype.ve = function(t) {
        return new St(this.root, t, this.N, !1);
    }, t.prototype.Se = function() {
        return new St(this.root, null, this.N, !0);
    }, t.prototype.Ce = function(t) {
        return new St(this.root, t, this.N, !0);
    }, t;
}(), St = /** @class */ function() {
    function t(t, e, n, r) {
        this.De = r, this.Fe = [];
 ...
 */ var Wt = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Xt.fs(e, n)), new t(g.min(), r, Qt(), qt(), Gt());
    }, t;
}(), Xt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Bs = function(t) {
        for (var e = 0, n = t.Is; e < n.length; e++) {
            var r = n[e];
            t.ms instanceof dt ? this.Us(r, t.ms) : t.ms instanceof yt && this.Qs(r, t.key, t.ms);
        }
    ...
    t.prototype.Js = function(t) {
        ...
        return this.qs = qt(), this.Ms = ne(), this.xs = new Pt(me), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.Ms.get(t);
        return e || (e = new Pt(me), this.Ms = this.Ms.Re(t, e)), e;
    }, 
    /**
 ...
 */ var ie = {
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.mi = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            var I = t.filter;
            I.targetId;
            var N = I.count || 0, A = new Rt(N), T = I.targetId;
            e = new Jt(T, A);
        }
        return e;
...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "_n", {
        ...
        return me(this.projectId, t.projectId) || me(this.database, t.database);
    }, t;
}(), Ee = /** @class */ function() {
    function t(t) {
        this.fn = t, 
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = jt, o = e.mutations, s = 0; s < o.length; s++) i = i.Re(o[s].key, r[s].version);
...
/** Represents the database ID a Firestore client is associated with. */ Re.er = -1;
 ...
 */ var Oe = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Pr = t, this.ir = e, this.Vr = n, this.op = r, this.pr = i, this.yr = new Ve, 
    ...
    function t() {
        ...
        this.kr = new ke(this, "async_queue_retry" /* AsyncQueueRetry */), 
...
var xe = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = g.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.Ih = new Te(this.dh, this.Dn, this.persistence.mh()), 
        this.ah.Rh(this.Ih)
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n = this.Dn, r = this.Ih, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        ...
                        return o.Dn.Ph(e).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new Te(o.dh, n, o.persistence.mh()), n.Ph(e);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = e.sent(), [ 2 /*return*/ , (this.Dn = n, this.Ih = r, this.ah.Rh(this.Ih), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    a = a.Re(i, h)) : fe("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
    ...
    t.Qh = function(t, e, n) {
        ...
        return ye(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Te.C() - t.Te.C() >= this.Yh || n.ws.size + n.Ts.size + n.Es.size > 0);
    ...
    t.prototype.ao = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.no(o, t.ee()).next((function(t) {
                ...
                return n.ah.Bn(o, t, e ? r : g.min(), e ? i : Gt());
            })).next((function(t) {
                return {
                    documents: t,
                    co: i
...
var je = /** @class */ function() {
    ...
    return t.do = function(t, e) {
        return E.N(t.key, e.key) || me(t.po, e.po);
    }, 
    /** Compare by ID then by key */ t.To = function(t, e) {
        return me(t.po, e.po) || E.N(t.key, e.key);
    }, t;
}();
 ...
 */ var fn = /** @class */ function() {
    ...
    return t.documentId = function() {
        ...
        if (!(e instanceof t)) throw on("isEqual", "FieldPath", 1, e);
...
var pn = new RegExp("[~\\*/\\[\\]]"), dn = function() {
    ...
    return e.__extends(n, t), n.prototype.Fo = function(t) {
        var e = new Rn({
            No: 3 /* Argument */ ,
            methodName: this.Do
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = kn(this.ko, e), r = new X(t.serializer, n);
        return new Z(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(dn), bn = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.delete = function() {
        return Ge("FieldValue.delete", arguments), new _n(new yn("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Ge("FieldValue.serverTimestamp", arguments), new _n(new vn("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Qe("FieldValue.arrayUnion", arguments, 1), new _n(new gn("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Qe("FieldValue.arrayRemove", arguments, 1), new _n(new mn("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return He("FieldValue.increment", "number", 1, t), ze("FieldValue.increment", arguments, 1), 
        new _n(new wn("FieldValue.increment", t));
    }, n;
}(dn), _n = /** @class */ function(t) {
    function n(e) {
        var n = this;
     ...
     */
    t.prototype.g = function(t) {
        return me(this.qo, t.qo) || me(this.Mo, t.Mo);
    }, t;
}(), In = /^__.*__$/, Nn = function(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var Rn = /** @class */ function() {
    /**
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Dn(this.No) && In.test(t)) throw this.$o('Document fields cannot begin and end with "__"');
    }, t;
}(), Vn = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.Xo = function(t, e) {
        ...
        Ln("Data must be an object, but it was:", n, e);
        var r = Un(e, n);
        return new An(new at(r), 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Zo = function(t, e, n) {
        ...
        Ln("Data must be an object, but it was:", r, e);
        var i, o, s = Un(e, r);
        if (n) {
    ...
    /** Parse update data from an update() call. */ t.prototype.ta = function(t, e) {
        ...
        var r = [], i = new ht;
        N(e, (function(e, o) {
            var s = On(t, e), u = n.Ko(s);
            if (o instanceof dn && o.Co instanceof yn) 
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.ea = function(t, e, n, r) {
        ...
        var g = new J(a);
        return new Tn(f.gt(), g, i.fieldTransforms);
    }, 
    ...
    t.prototype.sa = function(t, e, n) {
        return void 0 === n && (n = !1), kn(e, this.Jo(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function kn(t, e) {
    if (Sn(t)) return Ln("Unsupported field value:", e, t), Un(t, e);
    if (t instanceof dn) 
    ...
    return function(t, e) {
        ...
        if (!Dn(e.No)) throw e.$o(t.Do + "() can only be used with update() and set()");
...
function Sn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof v || t instanceof En || t instanceof fn || t instanceof Nn || t instanceof dn);
}
 ...
 */ function Pn(t, e) {
    ...
    if ("string" == typeof e) return On(t, e);
 ...
 */ function On(t, n) {
    try {
        return function(t) {
            if (t.search(pn) >= 0) throw new c(h.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (ln.bind.apply(ln, e.__spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var qn = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.ha = 0, this.oa = null, this.stream = null, this.kr = new ke(t, e)
        /**
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Ea(n) ];
    ...
    t.prototype.Ia = function(t) {
        ...
        return function(n) {
            e.sr.Sr((function() {
                return e.ha === t ? n() : (fe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return e.__extends(n, t), n.prototype.Aa = function(t) {
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "va", {
        /**
    ...
    n.prototype.start = function() {
        this.ba = !1, this.lastStreamToken = T.ht, t.prototype.start.call(this);
        ...
        ye(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.ba) {
        ...
        // The first response is always the handshake response
                return ye(!t.writeResults || 0 === t.writeResults.length), this.ba = !0, 
        this.listener.Da();
    }, 
    /**
...
}(qn), Fn = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).na = e, i.credentials = n, i.serializer = r, i;
    }
    ...
    return t.prototype.Ba = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Ua(), this.mutations.length > 0) throw new c(h.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , r.La("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof yt || t instanceof dt ? r.Qa(t) : de();
                    })), n) ];
                }
            }));
        }));
        ...
        this.write([ new st(t, this.Rt(t)) ]), this.xa.add(t);
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , r.$a("Commit", i) ];

                                  case 1:
                                    return o = e.sent(), [ 2 /*return*/ , r.serializer.ki(o.writeResults, o.commitTime) ];
                                }
                            }));
                        }));
    ...
    t.prototype.Rt = function(t) {
        ...
        return !this.xa.has(t) && e ? et.updateTime(e) : et.dt();
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.Ka ? (le(e), this.Ka = !1) : fe("OnlineStateTracker", e);
    ...
    n, r, i, o) {
        ...
        /**
             ...
             * again.
             */
        this.nu = !1, this.ru = o, this.ru.hu((function(t) {
            r.Sr((function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.ou() ? (fe("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.cu = function(t, e, n) {
            var r = ve(t);
            return new Cn(e, r.na, r.credentials, r.serializer, n);
        }(this.Oa, r, {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.eu.length > 0 && (fe("RemoteStore", "Stopping write stream with " + this.eu.length + " pending writes"), 
    ...
    t.prototype.bu = function(t) {
        ...
        this.iu = new ee(this), this.cu.start(), this.uu.za();
    }, 
    /**
    ...
    t.prototype.mu = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (this.uu.set("Online" /* Online */), !(t instanceof Zt && 2 /* Removed */ === t.state && t.cause)) 
                  ...
                  case 6:
                    if (t instanceof $t ? this.iu.Bs(t) : t instanceof Jt ? this.iu.zs(t) : this.iu.Ws(t), 
                    n.isEqual(g.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.tu.qh() ];

                  case 8:
                    return i = e.sent(), n.S(i) >= 0 ? [ 4 /*yield*/ , this.Du(n) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return fe("RemoteStore", "Failed to raise snapshot:", o = e.sent()), [ 4 /*yield*/ , this.Cu(o) ];
    ...
    t.prototype.Au = function() {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    t = this.eu.length > 0 ? this.eu[this.eu.length - 1].batchId : -1, e.label = 1;
                  ...
                  case 2:
                    return e.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.tu.to(t) ];

                  case 3:
                    return null === (n = e.sent()) ? (0 === this.eu.length && this.du._a(), [ 3 /*break*/ , 7 ]) : (t = n.batchId, 
                    this.Lu(n), [ 3 /*break*/ , 6 ]);

                  case 4:
                    return r = e.sent(), [ 4 /*yield*/ , this.Cu(r) ];
    ...
    t.prototype.Lu = function(t) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                for (t = 0, n = this.eu; t < n.length; t++) r = n[t], this.du.Sa(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = this.eu.shift(), i = Ne.from(r, t, n), [ 4 /*yield*/ , this.Fu((function() {
                        return o.vu.Mu(i);
                    })) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return Vt(r = t.code) && r !== h.ABORTED ? (n = this.eu.shift(), 
            ...
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    fe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.au() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 2:
                    return (n = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.Pu() ];
    ...
    function t() {
        this.Ku = new zn, this.zu = {}, this.vu = null, this.ja = null, this.Xn = null;
    }
    return t.prototype.Yu = function(t) {
        ...
        return this.Ku = new zn, Promise.resolve();
    ...
    e) {
        ...
        this.ns = Gt(), this.uc = new Wt(t.se.bind(t));
    }
    ...
    t.prototype.lc = function(t, e) {
        var n = this, r = e ? e._c : new Ht, i = e ? e.uc : this.uc, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, h = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.wc = function(t, e, n) {
        ...
        return this.oc = u, 0 !== o.length || a ? {
            snapshot: new Yt(this.query, t.uc, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ic: s
        } : {
            Ic: s
    ...
    t.prototype.Tc = function(t) {
        ...
        // updating many documents.
                var e = this.ac;
        this.ac = Gt(), this.uc.forEach((function(e) {
            t.Rc(e.key) && (t.ac = t.ac.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ac.has(e) || n.push(new Hn(e));
        })), this.ac.forEach((function(t) {
            e.has(t) || n.push(new Wn(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Pc = function() {
        return Yt.os(this.query, this.uc, this.ns, 0 /* Local */ === this.oc);
    }, t;
}(), Kn = /** @class */ function() {
    function t(t, e, n, r) {
        this.Pr = t, this.Oa = e, this.updateFunction = n, this.yr = r, this.Vc = 5, this.kr = new ke(this.Pr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.pc = function() {
        ...
        this.kr.lr((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = new jn(this.Oa), (n = this.gc(t)) && n.then((function(e) {
                        r.Pr.Sr((function() {
...
n) {
    ...
    r, i, o) {
        ...
        this.Nc = null, this.$c = new Ee((function(t) {
            return t.canonicalId();
        })), this.Lc = new Map, 
        /**
        ...
        /**
             ...
             */
        this.qc = new Map, this.Mc = new je, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.xc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Bc = new Map, this.Uc = Le.Ar(), this.onlineState = "Unknown" /* Unknown */;
    }
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    n = i.targetId, this.Dc.Ju(n), r = i.view.Pc(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.tu.io(t.ee()) ];

                  case 2:
                    return o = e.sent(), s = this.Dc.Ju(o.targetId), n = o.targetId, [ 4 /*yield*/ , this.jc(t, n, "current" === s) ];

                  case 3:
                    r = e.sent(), this.Qc && this.Cc.listen(o), e.label = 4;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new Yn(t, i.co), s = o.lc(i.documents), u = Xt.fs(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.wc(s, 
                    /* updateLimboDocuments= */ this.Qc, u), this.Gc(n, a.Ic), h = new Xn(t, n, o), 
                    [ 2 /*return*/ , (this.$c.set(t, h), this.Lc.has(n) ? this.Lc.get(n).push(t) : this.Lc.set(n, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.Wc("unlisten()"), n = this.$c.get(t), (r = this.Lc.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.Lc.set(n.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.$c.delete(t)) ] : this.Qc ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Dc.tc(n.targetId), this.Dc.nc(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.tu.oo(n.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Dc.sc(n.targetId), i.Cc.gu(n.targetId), i.Hc(n.targetId);
                    })).catch(Fe) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Hc(n.targetId), [ 4 /*yield*/ , this.tu.oo(n.targetId, 
    ...
    t.prototype.write = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Wc("write()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.tu.gh(t) ];

                  case 2:
                    return r = e.sent(), this.Dc.Yu(r.batchId), this.Kc(r.batchId, n), [ 4 /*yield*/ , this.zc(r.vh) ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.Cc.Au() ];

                  case 4:
                    return e.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = e.sent(), o = qe(i, "Failed to persist write"), n.reject(o), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Wc("applyRemoteEvent()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.tu.Mh(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        ye(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? n.Sc = !0 : t.Ts.size > 0 ? ye(n.Sc) : t.Es.size > 0 && (ye(n.Sc), 
                        n.Sc = !1));
                    })), [ 4 /*yield*/ , this.zc(n, t) ];
    ...
    t.prototype.mc = function(t, e) {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Dc.Zu(t, "rejected", n), r = this.qc.get(t), (i = r && r.key) ? (o = (o = new Ut(E.N)).Re(i, new yt(i, g.min())), 
                    s = Gt().add(i), u = new Kt(g.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Pt(me), o, s), [ 4 /*yield*/ , this.Mh(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Wc("applySuccessfulWrite()"), n = t.batch.batchId, e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.tu.Sh(t) ];
                  ...
                  case 2:
                    ...
                    this.Jc(n, /*error=*/ null), this.Zc(n), this.Dc.Xu(n, "acknowledged"), [ 4 /*yield*/ , this.zc(r) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Wc("rejectFailedWrite()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.tu.$h(t) ];
                  ...
                  case 2:
                    ...
                    // listen events.
                    this.Jc(t, n), this.Zc(t), this.Dc.Xu(t, "rejected", n), [ 4 /*yield*/ , this.zc(r) ];
    ...
    t.prototype.tl = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Cc.ou() || fe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.tu.kh() ];

                  case 2:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Bc.get(n) || []).push(t), 
                    this.Bc.set(n, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = e.sent(), o = qe(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.el = function(t) {
        ...
        n || (n = new Ut(me)), n = n.Re(t, e), this.xc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Jc = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Wn ? (this.Mc.Jh(i.key, t), this.nl(i)) : i instanceof Hn ? (fe("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.kc.get(e) || (fe("SyncEngine", "New document in limbo: " + e), this.Oc.push(e), 
        this.Xc());
    }, 
    /**
    ...
    t.prototype.Xc = function() {
        for (;this.Oc.length > 0 && this.kc.size < this.Fc; ) {
            ...
            this.qc.set(e, new $n(t)), this.kc = this.kc.Re(t, e), this.Cc.listen(new Dt(mt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Re.er));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.hl = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = [], i = [], o = [], this.$c.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            /* updateLimboDocuments= */ s.Qc, e);
                            if (s.Gc(u.targetId, o.Ic), o.snapshot) {
                                s.Qc && s.Dc.Zu(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), r.push(o.snapshot);
                  ...
                  case 1:
                    return e.sent(), this.Nc.pa(r), [ 4 /*yield*/ , this.tu.Xh(i) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    ...
                    this.Dc.Ah(t, n.ph, n.yh), [ 4 /*yield*/ , this.zc(n.Vh) ];
        ...
        var e = this.qc.get(t);
        if (e && e.Sc) return Gt().add(e.key);
        var n = Gt(), r = this.Lc.get(t);
        if (!r) return n;
    ...
    function t(t) {
        this.vu = t, this.ul = new Ee((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.ul.get(n)) || (r = !0, i = new Zn), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;
                  ...
                  case 2:
                    return o.ol = e.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = e.sent(), u = qe(s, "Initialization of query '" + t.query + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.ul.set(n, i), i.al.push(t), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return e.__generator(this, (function(e) {
                return n = t.query, r = !1, (i = this.ul.get(n)) && (o = i.al.indexOf(t)) >= 0 && (i.al.splice(o, 1), 
                r = 0 === i.al.length), r ? [ 2 /*return*/ , (this.ul.delete(n), this.vu.gu(n)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.mc = function(t) {
        ...
        t = Yt.os(t.query, t.docs, t.ns, t.fromCache), this.Tl = !0, this.wl.next(t);
    }, t;
}(), nr = /** @class */ function() {
    function t() {}
    return t.prototype.Rh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(g.min()) ? this.Vl(t, e) : this.Pl.qn(t, i).next((function(s) {
            var u = o.pl(e, s);
            return (e.oe() || e.ae()) && o.dc(e.xt, u, i, n) ? o.Vl(t, e) : (ce() <= r.LogLevel.DEBUG && fe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            o.Pl.Bn(t, e, n).next((function(t) {
    ...
    return t.prototype.bl = function(t) {
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.gl = this.gl.add(new Be(a.key, i)), this.Fn.Ir(t, a.key.path.O());
        }
        return Ae.resolve(o);
    }, t.prototype.Lh = function(t, e) {
        return Ae.resolve(this.vl(e));
        ...
        return Ae.resolve(0 === this.Dn.length ? -1 : this.yl - 1);
        ...
        // because it precedes all other segments in an ordered traversal.
                E.et(i) || (i = i.child(""));
        var o = new Be(new E(i), 0), s = new Pt(me);
        ...
        var n = this;
        ye(0 === this.Dl(e.batchId, "removed")), this.Dn.shift();
        var r = this.gl;
        ...
        var n = new Be(e, 0), r = this.gl.Ke(n);
 ...
 */
ir.kl = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Wl = e, n;
    }
    ...
    t.prototype.On = function(t, e) {
        this.Bl();
        var n = this.vh.get(e);
        return void 0 !== n ? Ae.resolve(n) : this.Ul(t, e);
    }, 
    /**
...
var or = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Hl = new je, this.targetCount = 0, this.Kl = Le.Rr();
    }
    return t.prototype.js = function(t, e) {
        ...
        return Ae.resolve(this.Gl);
    }, t.prototype.ro = function(t) {
        return this.highestTargetId = this.Kl.next(), Ae.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Kl = new Le(e), this.highestTargetId = e), t.sequenceNumber > this.Gl && (this.Gl = t.sequenceNumber);
    }, t.prototype.ho = function(t, e) {
        return this.Yl(e), this.targetCount += 1, Ae.resolve();
    }, t.prototype.Wh = function(t, e) {
        return this.Yl(e), Ae.resolve();
        ...
        return this.Hl.Eo(e, n), Ae.resolve();
        ...
        return this.Hl.Ro(e), Ae.resolve();
    }, t.prototype.uo = function(t, e) {
        var n = this.Hl.Po(e);
        return Ae.resolve(n);
    }, t.prototype.Vo = function(t, e) {
        return Ae.resolve(this.Hl.Vo(e));
    }, t;
}(), sr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.e_ = {}, this.s_ = new Re(0), this.i_ = !1, this.i_ = !0, this.Kh = t(this), 
        this.Th = new or(this), this.Fn = new Ue, this.Cn = new ir(this.Fn, (function(t) {
            return e.Kh.n_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.e_[t.s()];
        return e || (e = new rr(this.Fn, this.Kh), this.e_[t.s()] = e), e;
        ...
        return Ae.Sn(Object.values(this.e_).map((function(n) {
            return function() {
                return n.Vo(t, e);
            };
        })));
    ...
    return t.w_ = function(e) {
        ...
        return this.f_.Jh(n, e), this.T_.delete(n), Ae.resolve();
    }, t.prototype.Zh = function(t, e, n) {
        return this.f_.Zh(n, e), this.T_.add(n), Ae.resolve();
    }, t.prototype.Fl = function(t, e) {
        return this.T_.add(e), Ae.resolve();
        ...
        // Remove newly orphaned documents.
                return Ae.forEach(this.T_, (function(r) {
    ...
    return t.prototype.initialize = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), this.R_ = this.A_(t), this.tu = this.P_(t), this.Cc = this.V_(t), 
                    this.vu = this.p_(t), this.y_ = this.g_(t), this.Dc.ja = function(t) {
                        return n.vu.mc(t, 1 /* SharedClientState */);
                  ...
                  case 4:
                    return e.sent(), [ 4 /*yield*/ , this.Cc.Wu(this.vu.Qc) ];
        ...
        return new tr(this.vu);
    }, t.prototype.A_ = function(t) {
        return null;
    }, t.prototype.P_ = function(t) {
        return new xe(this.persistence, new nr, t.b_);
    }, t.prototype.m_ = function(t) {
        if (t.S_.v_) throw new c(h.FAILED_PRECONDITION, hr);
        return new sr(ar.w_);
    }, t.prototype.V_ = function(t) {
        var e = this;
        return new Gn(this.tu, t.Oa, t.Pr, (function(t) {
            return e.vu.mc(t, 0 /* RemoteStore */);
        }), t.platform.C_());
    }, t.prototype.I_ = function(t) {
        return new Qn;
    }, t.prototype.p_ = function(t) {
        return new Jn(this.tu, this.Cc, t.Oa, this.Dc, t.b_, t.Fc);
     ...
     */
    r) {
        this.platform = t, this.D_ = e, this.credentials = n, this.Pr = r, this.clientId = ge.cn()
        /**
    ...
    t.prototype.N_ = function(t, n, r, i) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(c) {
                switch (c.label) {
                  case 0:
                    return c.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.L_(this.D_) ];

                  case 1:
                    return o = c.sent(), s = this.platform.Yo(this.D_.ii), u = function(t, e, n) {
                        return new Fn(t, e, n);
                  ...
                  case 2:
                    return c.sent(), this.persistence = t.persistence, this.Dc = t.Dc, this.tu = t.tu, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.F_(), n = new Ve, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            var r, i, o;
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.tu.so(t) ];
                                  ...
                                  case 2:
                                    return i = e.sent(), o = qe(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.F_(), n = new Ve, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.tu.ao(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return r = e.sent(), i = new Yn(t, r.co), o = i.lc(r.documents), s = i.wc(o, 
                                    /* updateLimboDocuments= */ !1), n.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = e.sent(), a = qe(u, "Failed to execute query '" + t + " against cache"), 
...
var dr = /** @class */ function() {
    ...
    function t(t) {
        ...
        Xe("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Ce.hh; else {
            if (t.cacheSizeBytes !== yr && t.cacheSizeBytes < Ce.rh) throw new c(h.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Ce.rh);
    ...
    function t(n, r, i) {
        var o = this;
        if (void 0 === i && (i = new cr), this.J_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Z_ = new Me, this.INTERNAL = {
            delete: function() {
        ...
        this.rf = i, this.hf = new vr({});
    }
    return Object.defineProperty(t.prototype, "af", {
        get: function() {
            return this.uf || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.uf = new Vn(this.xo, this.hf.ignoreUndefinedProperties)), this.uf;
        },
        enumerable: !0,
        configurable: !0
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                ...
                return t = new Ve, [ 2 /*return*/ , (this.Z_.xr((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n, r;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
        ...
        if (this.tf(), pr(t)) return this.wf(t);
        ...
        var n = this.ff();
        return this.ef = new fr(ae.nt(), n, this.nf, this.Z_), this.ef.start(t, e);
    }, t.sf = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new c(h.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.tf(), new Nr(new mt(w.H, t), this);
    ...
    return t.prototype.get = function(t) {
        ...
        var n = kr("Transaction.get", t, this.If);
        return this.mf.Ba([ n.Bo ]).then((function(t) {
            if (!t || 1 !== t.length) return de();
            var r = t[0];
            if (r instanceof yt) return new Er(e.If, n.Bo, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Uo);
            if (r instanceof dt) return new Er(e.If, n.Bo, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Uo);
            throw de();
        }));
        ...
        var r = kr("Transaction.set", t, this.If);
        n = Dr("Transaction.set", n);
        var i = Sr(r.Uo, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.If.af.Zo(s, o, n.mergeFields) : this.If.af.Xo(s, o);
        return this.mf.set(r.Bo, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof ln ? (Qe("Transaction.update", arguments, 3), 
        r = kr("Transaction.update", t, this.If), i = this.If.af.ea("Transaction.update", e, n, o)) : (ze("Transaction.update", arguments, 2), 
        r = kr("Transaction.update", t, this.If), i = this.If.af.ta("Transaction.update", e)), 
        this.mf.update(r.Bo, i), this;
    }, t.prototype.delete = function(t) {
        ze("Transaction.delete", arguments, 1);
        var e = kr("Transaction.delete", t, this.If);
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = kr("WriteBatch.set", t, this.If);
        n = Dr("WriteBatch.set", n);
        var i = Sr(r.Uo, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.If.af.Zo(s, o, n.mergeFields) : this.If.af.Xo(s, o);
        return this.Rf = this.Rf.concat(u.Qo(r.Bo, et.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Pf(), "string" == typeof e || e instanceof ln ? (Qe("WriteBatch.update", arguments, 3), 
        r = kr("WriteBatch.update", t, this.If), i = this.If.af.ea("WriteBatch.update", e, n, o)) : (ze("WriteBatch.update", arguments, 2), 
        r = kr("WriteBatch.update", t, this.If), i = this.If.af.ta("WriteBatch.update", e)), 
        this.Rf = this.Rf.concat(i.Qo(r.Bo, et.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        ze("WriteBatch.delete", arguments, 1), this.Pf();
        var e = kr("WriteBatch.delete", t, this.If);
        return this.Rf = this.Rf.concat(new st(e.Bo, et.dt())), this;
    }, t.prototype.commit = function() {
    ...
    return e.__extends(n, t), n.Tf = function(t, e, r) {
        ...
        get: function() {
            return new Tr(this.Bo.path.O(), this.firestore, this.Uo);
        },
        enumerable: !0,
        configurable: !0
        ...
        var e = w.G(t);
        return new Tr(this.Bo.path.child(e), this.firestore);
    }, n.prototype.isEqual = function(t) {
        ...
        We("DocumentReference.set", arguments, 1, 2), e = Dr("DocumentReference.set", e);
        var n = Sr(this.Uo, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.af.Zo(i, r, e.mergeFields) : this.firestore.af.Xo(i, r);
        return this.ef.write(o.Qo(this.Bo, et.dt()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof ln ? (Qe("DocumentReference.update", arguments, 2), 
        n = this.firestore.af.ea("DocumentReference.update", t, e, r)) : (ze("DocumentReference.update", arguments, 1), 
        n = this.firestore.af.ta("DocumentReference.update", t)), this.ef.write(n.Qo(this.Bo, et.exists(!0)));
        ...
        "object" != typeof t[i] || pr(t[i]) || (rn("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Xe("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return pr(t[i]) ? n = t[i] : (He("DocumentReference.onSnapshot", "function", i, t[i]), 
        ...
        var i = new lr({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new Er(n.firestore, n.Bo, r, t.fromCache, t.hasPendingWrites, n.Uo));
                }
            },
            error: r
        }), o = this.ef.listen(mt.Wt(this.Bo.path), i, t);
        return function() {
            i.U_(), n.ef.gu(o);
        };
    }, n.prototype.get = function(t) {
        var e = this;
        return We("DocumentReference.get", arguments, 0, 1), Vr("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().M_(e.Bo).then((function(t) {
                n(new Er(e.firestore, e.Bo, t, 
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (We("DocumentSnapshot.data", arguments, 0, 1), t = Rr("DocumentSnapshot.data", t), 
        this.yf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Uo) {
                var n = new Ir(this.If, this.Bo, this.yf, this.gf, this.bf);
                return this.Uo.fromFirestore(n, t);
            }
            return new dr(this.If.xo, this.If.Ef(), t.serverTimestamps || "none", (function(t) {
                return new br(t, e.If);
            })).j_(this.yf.Ot());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (We("DocumentSnapshot.get", arguments, 1, 2), e = Rr("DocumentSnapshot.get", e), 
        this.yf) {
            var r = this.yf.data().field(Pn("DocumentSnapshot.get", t));
            if (null !== r) return new dr(this.If.xo, this.If.Ef(), e.serverTimestamps || "none", (function(t) {
                return new br(t, n.If, n.Uo);
            })).j_(r);
        }
        ...
        get: function() {
            return new br(this.Bo, this.If, this.Uo);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = Je("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n), s = Pn("Query.where", e);
        if (s.Y()) {
        ...
        return this.Df(p), new t(this.vf.Ht(p), this.firestore, this.Uo);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (We("Query.orderBy", arguments, 1, 2), Ye("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = Pn("Query.orderBy", e), o = new Tt(i, r);
        return this.Ff(o), new t(this.vf.Kt(o), this.firestore, this.Uo);
    }, t.prototype.limit = function(e) {
        return ze("Query.limit", arguments, 1), He("Query.limit", "number", 1, e), sn("Query.limit", 1, e), 
        new t(this.vf.zt(e), this.firestore, this.Uo);
    }, t.prototype.limitToLast = function(e) {
        return ze("Query.limitToLast", arguments, 1), He("Query.limitToLast", "number", 1, e), 
        sn("Query.limitToLast", 1, e), new t(this.vf.Yt(e), this.firestore, this.Uo);
        ...
        if (!(e instanceof t)) throw on("isEqual", "Query", 1, e);
    ...
    t.prototype.$f = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.vf.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(j(this.firestore.xo, t.key)); else {
    ...
    t.prototype.Lf = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                var a = new E(u);
                i.push(j(this.firestore.xo, a));
            } else {
                var f = this.firestore.af.sa(t, s);
                i.push(f);
            }
        }
        return new At(i, n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || pr(t[i]) || (rn("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Xe("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), pr(t[i]) ? n = t[i] : (He("Query.onSnapshot", "function", i, t[i]), Ye("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        ...
        var i = new lr({
            next: function(t) {
                e.next && e.next(new Ar(n.firestore, n.vf, t, n.Uo));
            },
            error: r
        ...
        var e = this;
        return We("Query.get", arguments, 0, 1), Vr("Query.get", t), this.Of(this.vf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.tf().x_(e.vf).then((function(t) {
                n(new Ar(e.firestore, e.vf, t, e.Uo));
            }), r) : e.pf(n, r, t);
        }));
    ...
    t.prototype.Cf = function(t) {
        if ("string" == typeof t) {
            ...
            return j(this.firestore.xo, new E(e));
        }
        if (t instanceof br) {
            var n = t;
            return j(this.firestore.xo, n.Bo);
        }
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new Nr(this.qf, this.If, this.Uo);
        },
        enumerable: !0,
        configurable: !0
        ...
        function(t, e, n, r) {
            if (n.ss.M()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new Ir(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new Ir(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new Ir(this.If, t.key, t, this.metadata.fromCache, this.Mf.ns.has(t.key), this.Uo);
    }, t;
}(), Tr = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, mt.Wt(e), n, r) || this).Qf = e, e.length % 2 != 1) throw new c(h.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.j() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new br(new E(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(n.prototype, "path", {
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ge.cn()), He("CollectionReference.doc", "non-empty string", 1, t);
        var e = w.G(t);
        return br.Tf(this.vf.path.child(e), this.firestore, this.Uo);
...
function Dr(t, e) {
    ...
    if (rn(t, e, [ "merge", "mergeFields" ]), Xe(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        ...
        return "string" == typeof t || t instanceof ln;
...
var Pr = Lr(gr, "Use firebase.firestore() instead."), Or = Lr(mr, "Use firebase.firestore().runTransaction() instead."), Mr = Lr(wr, "Use firebase.firestore().batch() instead."), qr = Lr(br, "Use firebase.firestore().doc() instead."), Cr = Lr(Er), xr = Lr(Ir), Fr = Lr(Nr), jr = Lr(Ar), Br = Lr(Tr, "Use firebase.firestore().collection() instead."), Gr = Lr(bn, "Use FieldValue.<field>() instead."), zr = Lr(fn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Qr = {
    Firestore: Pr,
    GeoPoint: En,
    Timestamp: v,
    Blob: zr,
    ...
    Commit: "commit"
}, Xr = "gl-js/ fire/" + u, $r = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.od = function(t, e) {
        ...
        var o = [ this.hd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], a = s.createWebChannelTransport(), f = {
        ...
        this.od(f.initMessageHeaders, n), 
        ...
        var p = a.createWebChannel(l, f), d = !1, y = !1, v = new Yr({
            Xf: function(t) {
        ...
        return g(s.WebChannel.EventType.OPEN, (function() {
            ...
            y || (y = !0, fe("Connection", "WebChannel transport closed"), v.nd());
            ...
            }("Connection", "WebChannel transport errored:", t), v.nd(new c(h.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!y) {
                ...
                if (i) {
                    ...
                    y = !0, v.nd(new c(s, u)), p.close();
                } else fe("Connection", "WebChannel received:", n), v.rd(n);
            }
        })), setTimeout((function() {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new o.Component("firestore", (function(t) {
            return function(t, e) {
                return new gr(t, e, new cr);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Qr)));
...
ae.an(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new $r(t));
    }, t.prototype.C_ = function() {
        return Hr.Yf() ? new Hr : new Wr;
