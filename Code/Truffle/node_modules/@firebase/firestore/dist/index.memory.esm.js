...
var E = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new I(E.ABORTED, "getToken aborted due to token change.");
            return n ? (De("string" == typeof n.accessToken), new N(n.accessToken, t.currentUser)) : null;
...
var S = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.$ = function(t, e, r) {
 ...
 */ var Nn = /** @class */ function() {
    ...
    function t() {
        ...
        for (var n = 0; n < t.length; ++n) if (sn("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new I(E.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.vo = new P(t);
    }
...
function Gn(t, e) {
    ...
    e.path && e.path.length > 0 && e.Vt.push(e.path) : M(t, (function(t, r) {
        var i = Bn(r, e.Go(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function zn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R || t instanceof On || t instanceof Nn || t instanceof Mn || t instanceof _n);
}
 ...
 */ function Hn(t, e) {
    try {
        return function(t) {
            if (t.search(Tn) >= 0) throw new I(E.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (An.bind.apply(An, r([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var Kn = /** @class */ function() {
    ...
    return t(n, e), n.prototype.Aa = function(t) {
    ...
    return t(n, e), Object.defineProperty(n.prototype, "va", {
        /**
    ...
    n.prototype.start = function() {
        this.ba = !1, this.lastStreamToken = C.ht, e.prototype.start.call(this);
    ...
    /** Gets an auth token and invokes the provided RPC. */    return t(n, e), n.prototype.$a = function(t, e) {
        var n = this;
    ...
    t.prototype.Lu = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return jt(r = t.code) && r !== E.ABORTED ? (e = this.eu.shift(), 
...
n) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Dc.Zu(t, "rejected", r), e = this.qc.get(t), (i = e && e.key) ? (o = (o = new Gt(O.N)).Re(i, new Dt(i, V.min())), 
    ...
    return t.prototype.Rh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(V.min()) ? this.Vl(t, e) : this.Pl.qn(t, r).next((function(o) {
            var u = i.pl(e, o);
            return (e.oe() || e.ae()) && i.dc(e.xt, u, r, n) ? i.Vl(t, e) : (Ie() <= s.DEBUG && Ne("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
...
vr.kl = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.wc = function(t) {
        var e = this, n = [];
...
var mr = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.S_.v_) throw new I(E.FAILED_PRECONDITION, Er);
        return new gr(br.w_);
        ...
        throw new I(E.FAILED_PRECONDITION, Er);
    }, t;
}(), Nr = /** @class */ function() {
    function t(t, e, n, 
    /**
...
var _r = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        var e = this, n = {};
        return M(t.fields || {}, (function(t, r) {
            n[t] = e.j_(r);
        })), n;
    ...
    function t(t) {
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.hh; else {
            if (t.cacheSizeBytes !== Dr && t.cacheSizeBytes < Xe.rh) throw new I(E.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.rh);
 ...
 */        if (!n || "string" != typeof n) throw new I(E.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.tf(), new Mr(new kt(U.H, t), this);
    ...
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new Sr(new O(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(n.prototype, "path", {
...
var Wr = Qr(Vr, "Use firebase.firestore() instead."), Hr = Qr(kr, "Use firebase.firestore().runTransaction() instead."), Yr = Qr(Ur, "Use firebase.firestore().batch() instead."), Kr = Qr(Sr, "Use firebase.firestore().doc() instead."), Xr = Qr(Or), $r = Qr(Lr), Jr = Qr(Mr), Zr = Qr(qr), ti = Qr(Cr, "Use firebase.firestore().collection() instead."), ei = Qr(Sn, "Use FieldValue.<field>() instead."), ni = Qr(Nn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), ri = {
    ...
    Commit: "commit"
}, ai = "gl-js/ fire/" + w, hi = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
...
export { ci as __PRIVATE_registerFirestore };
