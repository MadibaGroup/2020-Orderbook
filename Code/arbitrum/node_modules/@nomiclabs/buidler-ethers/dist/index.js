...
function default_1() {
    config_1.extendEnvironment((env) => {
        env.ethers = plugins_1.lazyObject(() => {
            ...
            return Object.assign(Object.assign({}, ethers), { provider: new EthersProviderWrapper(env.network.provider), getSigners: async () => helpers_1.getSigners(env), 
                ...
                // Deprecated:
                getContract: (name) => helpers_1.getContractFactory(env, name), signers: () => helpers_1.getSigners(env) });
        });
    });
}
