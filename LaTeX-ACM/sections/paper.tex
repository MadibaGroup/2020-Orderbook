...
Clearing storage is important for reducing EVM bloat. The Ethereum refund model should be considered further by Ethereum developers to provide a better incentive to be less wasteful in using storage.
