...
\textblue{add sth about the " traversing data structures with e.g., 100 elements on-chain is not possible." contribution somewhere in the intro or contribution section}
...
\cm is designed as a base class that can be extended and customized. Here, we discuss potential modifications \textblue{and provide evaluation}.  
% = = = = = = = = = = = = = = = = = = = = = = = = =  %
