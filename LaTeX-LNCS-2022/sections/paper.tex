...
In \cm, both the tokens and ETH that a trader wants to potentially use in the order book are preloaded into the contract. We discuss some alternative designs in~\cite{https://doi.org/10.48550/arxiv.2101.06291}.
