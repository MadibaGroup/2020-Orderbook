...
\textblue{Edits to be made:}
\begin{enumerate}
\item \textblue{Different market participants would have different preference about various markets. Which one is best for which? Jeremy in proposal: could be a chart}
\item  \textblue{Add a subsection on latency }
\item  \textblue{For enqueue and dequeue performance tests, justify why you picked 50 integers}
