...
\caption{\footnotesize{Gas costs for enqueuing 50 random integers into five priority queue variants. For the x-axis, a value of 9 indicates it is the 9th number entered in the priority queue. The y-axis is the cost of enqueuing in gas.}  \label{fig:random_insertion}}
\end{figure}
...
As a module, we try to keep \cm as simple as possible, and allow customizations and extensions as appropriate. We discuss potential modifications here.  
